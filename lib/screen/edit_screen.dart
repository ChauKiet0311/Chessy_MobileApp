                    ...
                    children: [   
                      ...
                      Column(
                        children: [
                          ...
                          EditTextField("Name", nameTextController, hint: 'Type in your name',icon: Icon(Icons.abc)),
                          const SizedBox(height: 15),
                          EditTextField("Email", emailTextController,hint: 'Type in your email address', icon: Icon(Icons.abc)),
                        ],
                      ),       
